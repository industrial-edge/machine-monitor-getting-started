...
The user can save the configuration of the Machine Monitor app using the "Backup and restore" function. In order to use this function, the user has to click on "Settings" then "Backup and restore". The user can either create a backup or restore a backup file.

![machine_monitor](graphics/Machine_Monitor_Backup.png)

By utilizing the backup and restore feature, the user can easily save and restore the app configuration as needed.
